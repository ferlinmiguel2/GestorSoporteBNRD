...
import ToggleDialog from "@/app/[lang]/(dashboard)/(components)/dialog/toggle-dialog";
...
const columns = [
  ...
  },
  {
    ...
    header: "Situación",
    cell: ({ row }) => <span>{row.getValue("situation")}</span>
  },
  {
    accessorKey: "isComplete",
    header: "Estatus de solicitud",
    cell: ({ row }) => (
  ...
  },
  {
    accessorKey: "Casa",
    header: "Detalles",
    cell: ({ row }) => <ToggleDialog />
  }
];

const RecientesTable = () => {
